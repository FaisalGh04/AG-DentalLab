...
// A varied grid layout keeps the section looking intentional while empty; the
// labels come from the "work.items" array so they translate with the locale.
